...
| `font-leading-loose-01`     | _Set line height as 1.75em_                   | `line-height`       | 1.175        |
...
headings-h1: {
  ...
  font-size:        font-scale-08; 
  font-style:       font-normal;
  text-transform:   initial;
  letter-spacing:   font-tracking-tight-01;
  line-height:      font-leading-compact-01;  
}
```
