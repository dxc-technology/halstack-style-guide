...
import headingVariants from "./images/heading.png";
    ...
    <DxcStack gutter="xxxlarge">
      <DxcStack gutter="large">
        ...
        <DxcText as="p">
          ...
          For each variation, it exists an italic form that is used in some
          scenarios. The font size goes from 60 pixels for the more prominent
          heading to 20 pixels for the lowest title level.
        </DxcText>
        <Image src={headingVariants} alt="Variations of the heading" />
        <DxcText as="p">
