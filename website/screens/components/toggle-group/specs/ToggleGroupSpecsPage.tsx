import { DxcTable, DxcStack, DxcText, DxcList } from "@dxc-technology/halstack-react";
    ...
    <DxcStack gutter="xxxlarge">
      ...
      <DxcStack gutter="large">
        ...
        <DxcText as="p">
          ...
          <strong>unselected focus</strong>, <strong>unselected active</strong>,{" "}
          <strong>unselected disabled</strong>, <strong>selected enabled</strong>,{" "}
          <strong>selected hover</strong>, <strong>selected focus</strong>,{" "}
          <strong>selected active</strong> and <strong>selected disabled</strong>
        </DxcText>
